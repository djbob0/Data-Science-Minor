...
for filename in os.listdir(directory):
    if filename.endswith(".csv"): 
        ...
        df = read_dataframe_from_file('D:\\Hochschule\\5_Semester\\Orthoeyes\\Data\\test-data\\'+ filename)
        ...
        ob_dub.name = filename[:-4] + ' ' + rotation_mode + ' trans_no: ' + str(trans_no) + ' trans_l: ' + str(trans_l)
        #bpy.data.collections['Result'].objects.link(ob_dub)
        bpy.ops.object.mode_set(mode='OBJECT')
