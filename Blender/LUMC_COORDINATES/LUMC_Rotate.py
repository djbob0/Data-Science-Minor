...
def read_dataframe_from_file(filename):
    ...
    if os.path.exists(filename):
        ...
        dataframe = dataframe.rename(columns={3: "clavicula_r_y", 4: "clavicula_r_z", 5: "clavicula_r_x"})
        dataframe = dataframe.rename(columns={6: "scapula_r_y", 7: "scapula_r_z", 8: "scapula_r_x"})
        dataframe = dataframe.rename(columns={9: "humerus_r_y", 10: "humerus_r_z", 11: "humerus_r_y2"})
        ...
        dataframe = dataframe.rename(columns={18: "clavicula_l_y", 19: "clavicula_l_z", 20: "clavicula_l_x"})
        dataframe = dataframe.rename(columns={21: "scapula_l_y", 22: "scapula_l_z", 23: "scapula_l_x"})
        dataframe = dataframe.rename(columns={24: "humerus_l_y", 25: "humerus_l_z", 26: "humerus_l_y2"})
...
for key in range(int(int(df_thorax_r.size) / 3)):
    ...
    thorax_r_euler = np.array([(math.radians((df_thorax_r.loc[key,'thorax_r_z']))), (math.radians((df_thorax_r.loc[key,'thorax_r_y']))), (math.radians((df_thorax_r.loc[key,'thorax_r_x'])))])
    thorax_l_euler = np.array([(math.radians((df_thorax_l.loc[key,'thorax_l_z']))), (math.radians((df_thorax_l.loc[key,'thorax_l_y']))), (math.radians((df_thorax_l.loc[key,'thorax_l_x'])))])
    ...
    clavicula_r_euler = np.array([-(math.radians((df_clavicula_r.loc[key,'clavicula_r_z']))), (math.radians((df_clavicula_r.loc[key,'clavicula_r_x']))), (math.radians((df_clavicula_r.loc[key,'clavicula_r_y'])))])
    clavicula_l_euler = np.array([(math.radians((df_clavicula_l.loc[key,'clavicula_l_z']))), (math.radians((df_clavicula_l.loc[key,'clavicula_l_x']))), (math.radians((df_clavicula_l.loc[key,'clavicula_l_z'])))])
    ...
    scapula_r_euler = np.array([(math.radians((df_scapula_r.loc[key,'scapula_r_z']))), (math.radians((df_scapula_r.loc[key,'scapula_r_x']))), (math.radians((df_scapula_r.loc[key,'scapula_r_y'])))])
    scapula_l_euler = np.array([(math.radians((df_scapula_l.loc[key,'scapula_l_x']))), (math.radians((df_scapula_l.loc[key,'scapula_l_y']))), (math.radians((df_scapula_l.loc[key,'scapula_l_z'])))])
    ...
    humerus_r_euler = np.array([(math.radians((df_humerus_r.loc[key,'humerus_r_y']))), (math.radians((df_humerus_r.loc[key, 'humerus_r_z']))), (math.radians((df_humerus_r.loc[key, 'humerus_r_y2'])))])
    humerus_l_euler = np.array([(math.radians((df_humerus_l.loc[key,'humerus_l_y']))), (math.radians((df_humerus_l.loc[key, 'humerus_l_z']))), (math.radians((df_humerus_l.loc[key, 'humerus_l_y2'])))])
